...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<p class="news-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
        ...
        <?echo implode(' ', array_slice(explode(' ', $arItem["PREVIEW_TEXT"]), 0,10)).'<span id="dots">...</span><span id= "<?=$arItem["ID"]?>" class="'.$arItem["ID"].'more">'.implode(' ', array_slice(explode(' ', $arItem["PREVIEW_TEXT"]), 8)).'</span>';?>
